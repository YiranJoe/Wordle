...
//			Color a=new Color((int)Math.random()*254+1,(int)Math.random()*254+1,(int)Math.random()*254+1);
			g.setColor(blocks.get(i).getCOlor());
			g.fillRect(blocks.get(i).x,blocks.get(i).getY(),10,10);
		}
